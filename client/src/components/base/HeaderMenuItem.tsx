    ...
    <div className="p-4 hover:bg-[#FAFAFA] rounded-lg">
      <div className="flex items-center">
        ...
        <div className="flex flex-col ">
          <div className="text-xs   text-[#1E2329] font-Roboto font-medium">{title}</div>
          <div className="text-[0.75rem] truncate w-52 text-[#707A8A] leading-normal   font-Roboto  font-medium">
            {subTitle}
          </div>
        </div>
      </div>
