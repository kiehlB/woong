...
export const colourOptions: readonly ColourOption[] = [
  { value: 'Beginner', label: 'Beginner', color: '#02C076', isFixed: true },
  { value: 'Intermediate', label: 'Intermediate', color: '#f0b90b', isFixed: true },
  { value: 'Advanced', label: 'Advanced', color: '#d9304e', isFixed: true },
];
